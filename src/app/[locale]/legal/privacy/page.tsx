    ...
    <div style={{ paddingTop: 'clamp(6rem, 12vw, 8rem)', paddingBottom: 'clamp(4rem, 8vw, 6rem)' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '0 1.5rem' }}>
        ...
        <h1 style={{
          ...
          {t('privacy_title').replace(' - Traviosoft', '')}
        </h1>
        ...
        <div style={{
          ...
          <p>
            This privacy policy will be completed before the website goes live. It will cover data collected through the site (contact forms, analytics, cookies), how it is stored, your rights, and how to contact us.
          </p>
          <p>
